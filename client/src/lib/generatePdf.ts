...
const ACTIONS_MAP: Record<string, { short: string; actions: string[] }> = {
  ...
  "Compromisso com o Local de Trabalho": { short: "Engajamento e vínculo organizacional", actions: ["Investigar fatores de desengajamento e implementar ações de retenção.", "Criar oportunidades de crescimento interno e plano de carreira."] },
